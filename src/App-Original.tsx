...
const WeddingWebsite = () => {
  return (
    <div style={{ 
      ...
      {/* Our Story Section */}
      <section id="details" className="section-padding" style={{ 
              ...
              <form style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                <div>
                  ...
                  <input 
                    ...
                    style={{ 
                      ...
                      ':focus': { borderColor: '#C9A96E', outline: 'none' }
                    }}
                ...
                <div>
                  <label style={{ 
                    ...
                    fontWeight: '400',
                    letterSpacing: '0.5px'
                  }}>Will you be bringing a plus one?</label>
                  <select style={{ 
                    width: '100%', 
                    padding: '1rem 1.2rem', 
                    border: '2px solid #E5D5B7', 
                    ...
                    <option>Yes, bringing my plus one! 👫</option>
                  </select>
                </div>
